...
export const Card = styled.div<{widthOverride ?: string}>`
  ...
  border: 2px solid;
  border-image-source: radial-gradient(80.38% 222.5% at -13.75% -12.36%, #FFFFFF 0%, rgba(255, 255, 255, 0) 100%),radial-gradient(80.69% 208.78% at 108.28% 112.58%, #FFFFFF 0%, rgba(18, 30, 52, 0) 100%);
